...
const properties: INodeProperties[] = [
	{
		displayName:
			'Documentation: <a href="https://www.bitdefender.com/business/support/en/77209-532512-updatepackage.html" target="_blank" rel="noopener noreferrer">Update Package</a>',
		name: 'updatePackageDocsNotice',
		type: 'notice',
		default: '',
	},
	{
...
const displayOptions = {
	show: { category: ['packages'], action: ['updatePackage'] },
};
...
export async function execute(this: IExecuteFunctions, i: number): Promise<INodeExecutionData[]> {
	...
	const params: IDataObject = { packageId, packageName };
	...
	const responseData = await gravityZoneApiRequest.call(this, 'packages', 'updatePackage', params);
